(require 'ww-init)
(add-search-path "el-get/org-mode")
(add-search-path "el-get/org-impress-js")
(require 'ox-impress-js)

(setq user-local-lib (concat user-home-dir "/local/lib"))
(defvar ww/org-pygment-path
  (cond
...
(defvar ww/org-twopi-path
  (cond
   ((file-executable-p "/usr/local/bin/twopi")
    "/usr/local/bin/twopi")
   (t "/usr/bin/twopi")
   ))
(defvar ww/org-ditaa-jar-path (concat user-local-lib "/java/ditaa.jar"))
(defvar ww/org-plantuml-jar-path (concat user-local-lib "/java/plantuml.jar"))
...
(defun djcb-ditaa-generate ()
  (interactive)
  (shell-command (concat "java -jar " ww/org-ditaa-jar-path " " buffer-file-name)))
;; }}}
...
(defun ww/org-publish (project &optional force)
